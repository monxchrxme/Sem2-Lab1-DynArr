    ...
    while (1) {
        ...
        switch (choice) {
            case 1: {
                ...
                double norm1 = vector3d_normal(&vec1);
                double norm2 = vector3d_normal(&vec2);

                printf("\n--- Результаты вычислений ---\n");
                printf("Норма Вектора 1: %.4f\n", norm1);
                printf("Норма Вектора 2: %.4f\n", norm2);
                printf("-----------------------------\n");

                int cmp = vector3d_compare_by_normal(&vec1, &vec2);
                if (cmp < 0) {
                    printf("Итог: Вектор 1 < Вектор 2 (норма вектора 1 меньше)\n");
                } else if (cmp > 0) {
                    printf("Итог: Вектор 1 > Вектор 2 (норма вектора 1 больше)\n");
                } else {
                    printf("Итог: Вектора равны (нормы совпадают)\n");
                }
            ...
            case 2: {
                ...
                printf("\n--- Результаты вычислений ---\n");
                printf("Норма Вектора 1: %.4f (кол-во ненулевых функций)\n", norm1);
                printf("Норма Вектора 2: %.4f (кол-во ненулевых функций)\n", norm2);
                printf("-----------------------------\n");

                int cmp = vector3d_compare_by_normal(&vec1, &vec2);
                if (cmp < 0) {
                    printf("Итог: Вектор 1 < Вектор 2 (меньше ненулевых функций)\n");
                } else if (cmp > 0) {
                    printf("Итог: Вектор 1 > Вектор 2 (больше ненулевых функций)\n");
                } else {
                    printf("Итог: Вектора равны (одинаковое количество ненулевых функций)\n");
                }
                break;
            }
            case 3:
